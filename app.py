...
# === SECTION 3: Corrected Totals Odds ===
#st.header("Corrected Totals Odds")
st.markdown("### <span class='custom-header'>Corrected Totals Odds</span>", unsafe_allow_html=True)
...
with st.expander("🔢 Expand to View Totals Corrected", expanded=False):
    ...
    #draw_top_bets_plot_arguments(filtered_totals_corrected,"🔢 Totals: Price vs ROI",list(filtered_totals_corrected.columns))
